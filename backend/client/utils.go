...
// }
//
// type ResponseData[T cmn.ExternalItem, U ResponseItem[T]] interface {
// 	Items() []U
// }
//
// func TestRead[T cmn.ExternalItem, R ResponseItem[T], D ResponseData[T, R]](c cmn.Client, resp *http.Response, userID string) (res cmn.SearchResult, err error) {
// 	var data D
...
// 		item := r.ToDBItem()
// 		if err = c.CacheMedia(item); err != nil {
// 			return
// 		}
...
//
// 	if err = c.GetDB().Where("user_id = ?", userID).Where("media_id IN ?", mediaIDs).Find(&tracking).Error; err != nil {
// 		return
// 	}
//
